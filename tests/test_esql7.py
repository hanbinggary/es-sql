from es_sql7 import Client
from es_sqlparser import do_test

# do_test()
c = Client('10.68.23.89:9207')
...
### select
# print(c.execute('select _index,_id,* from people'))
# print(c.execute('select * from people'))
# print(c.execute('select user,age from people'))
